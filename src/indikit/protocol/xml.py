...
* :class:`XMLStreamParser` consumes the raw byte stream from a socket or stdio
  pipe and yields fully-formed :data:`~indikit.protocol.models.IndiMessage`
...
from indikit.protocol.compression import inflate_blob, require_declared_size
from indikit.protocol.enums import BLOBPolicy, IPerm, IPState, ISRule, ISState
...
def _optts(v: str | None) -> dt.datetime | None:
    ...
    the model's job (:data:`~indikit.protocol.models.IndiTimestamp`), and
